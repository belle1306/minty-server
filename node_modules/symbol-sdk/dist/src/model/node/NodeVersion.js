...
class NodeVersion {
     ...
     * @returns {NodeVersion}
     */
    static createFromRawNodeVersion(rawNodeVersion) {
     ...
     * @returns {NodeVersion}
     */
    static createFromFormattedNodeVersion(formattedNodeVersion) {
 ...
 */
NodeVersion.isValidRawNodeVersion = (rawNodeVersion) => {
 ...
 */
NodeVersion.isValidFormattedNodeVersion = (formattedNodeVersion) => {
    ...
    const isVersionChuncksValid = !versionChuncks.find((value) => isNaN(value) || value < minFormattedNodeVersionChunkValue || value > maxFormattedNodeVersionChunkValue);
