...
class AccountAddressRestrictionTransaction extends Transaction_1.Transaction {
    ...
    static createFromPayload(payload, isEmbedded = false) {
        ...
        const transaction = AccountAddressRestrictionTransaction.create(isEmbedded
            ...
            : Deadline_1.Deadline.createFromDTO(builder.getDeadline().timestamp), catbuffer_typescript_1.GeneratorUtils.fromFlags(catbuffer_typescript_1.AccountRestrictionFlagsDto, builder.getRestrictionFlags()), builder.getRestrictionAdditions().map((addition) => {
     ...
     */
    createBuilder() {
        const transactionBuilder = new catbuffer_typescript_1.AccountAddressRestrictionTransactionBuilder(this.getSignatureAsBuilder(), this.getSignerAsBuilder(), this.versionToDTO(), this.networkType.valueOf(), TransactionType_1.TransactionType.ACCOUNT_ADDRESS_RESTRICTION.valueOf(), new catbuffer_typescript_1.AmountDto(this.maxFee.toDTO()), new catbuffer_typescript_1.TimestampDto(this.deadline.toDTO()), catbuffer_typescript_1.GeneratorUtils.toFlags(catbuffer_typescript_1.AccountRestrictionFlagsDto, this.restrictionFlags.valueOf()), this.restrictionAdditions.map((addition) => {
