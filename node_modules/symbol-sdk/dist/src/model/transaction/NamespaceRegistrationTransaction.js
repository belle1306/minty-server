...
class NamespaceRegistrationTransaction extends Transaction_1.Transaction {
    ...
    static createSubNamespace(deadline, namespaceName, parentNamespace, networkType, maxFee = new UInt64_1.UInt64([0, 0]), signature, signer) {
        ...
        if (typeof parentNamespace === 'string') {
            parentId = new namespace_1.NamespaceId(transaction_1.NamespaceMosaicIdGenerator.subnamespaceParentId(parentNamespace, namespaceName));
        }
        else {
            parentId = parentNamespace;
        }
        const namespaceId = typeof parentNamespace === 'string'
            ? new namespace_1.NamespaceId(transaction_1.NamespaceMosaicIdGenerator.subnamespaceNamespaceId(parentNamespace, namespaceName))
    ...
    createBuilder() {
        ...
        if (this.registrationType === namespace_1.NamespaceRegistrationType.RootNamespace) {
            transactionBuilder = catbuffer_typescript_1.NamespaceRegistrationTransactionBuilder.createNamespaceRegistrationTransactionBuilderRoot(this.getSignatureAsBuilder(), this.getSignerAsBuilder(), this.versionToDTO(), this.networkType.valueOf(), TransactionType_1.TransactionType.NAMESPACE_REGISTRATION.valueOf(), new catbuffer_typescript_1.AmountDto(this.maxFee.toDTO()), new catbuffer_typescript_1.TimestampDto(this.deadline.toDTO()), new catbuffer_typescript_1.BlockDurationDto(this.duration.toDTO()), this.namespaceId.toBuilder(), format_1.Convert.hexToUint8(format_1.Convert.utf8ToHex(this.namespaceName)));
        }
        else {
            transactionBuilder = catbuffer_typescript_1.NamespaceRegistrationTransactionBuilder.createNamespaceRegistrationTransactionBuilderChild(this.getSignatureAsBuilder(), this.getSignerAsBuilder(), this.versionToDTO(), this.networkType.valueOf(), TransactionType_1.TransactionType.NAMESPACE_REGISTRATION.valueOf(), new catbuffer_typescript_1.AmountDto(this.maxFee.toDTO()), new catbuffer_typescript_1.TimestampDto(this.deadline.toDTO()), this.parentId.toBuilder(), this.namespaceId.toBuilder(), format_1.Convert.hexToUint8(format_1.Convert.utf8ToHex(this.namespaceName)));
        }
    ...
    toEmbeddedTransaction() {
        if (this.registrationType === namespace_1.NamespaceRegistrationType.RootNamespace) {
            return catbuffer_typescript_1.EmbeddedNamespaceRegistrationTransactionBuilder.createEmbeddedNamespaceRegistrationTransactionBuilderRoot(this.getSignerAsBuilder(), this.versionToDTO(), this.networkType.valueOf(), TransactionType_1.TransactionType.NAMESPACE_REGISTRATION.valueOf(), new catbuffer_typescript_1.BlockDurationDto(this.duration.toDTO()), this.namespaceId.toBuilder(), format_1.Convert.hexToUint8(format_1.Convert.utf8ToHex(this.namespaceName)));
        }
        return catbuffer_typescript_1.EmbeddedNamespaceRegistrationTransactionBuilder.createEmbeddedNamespaceRegistrationTransactionBuilderChild(this.getSignerAsBuilder(), this.versionToDTO(), this.networkType.valueOf(), TransactionType_1.TransactionType.NAMESPACE_REGISTRATION.valueOf(), this.parentId.toBuilder(), this.namespaceId.toBuilder(), format_1.Convert.hexToUint8(format_1.Convert.utf8ToHex(this.namespaceName)));
    }
    /**
     * @internal
     * @returns {NamespaceRegistrationTransaction}
